...
/* ── 손에 든 것 ────────────────────────────────────────────
   무기는 직업 그림에 구워 넣으면 안 됩니다. 장착을 바꿔도 그림이
   안 바뀌기 때문입니다. 그래서 별도 층으로 빼서, 주인공을 찍은 뒤
   **실제 장착한 무기**를 그 위에 겹칩니다.

   여덟 종류(data.js의 `t`)마다 방향 셋. 여백은 전부 투명입니다.

   **어느 쪽을 보든 같은 손이어야 합니다.** 오른손잡이라고 두면, 정면을
   볼 때 그 사람의 오른손은 화면 왼쪽에 오고 등을 보일 때는 화면
   오른쪽에 옵니다. 그래서 `down`과 `up`은 좌우가 반대입니다. 옆모습은
   앞쪽(진행 방향)에 두고, 왼쪽을 볼 때는 통째로 뒤집으므로 손은 그대로
   따라갑니다.                                                  */
export const HELD = {
  sword: {
    down: [
  ...
  great: {
    down: [
      '2SS2...........','................','................','................',
      '.SWWS2..........','.SWWS2..........','.SWWS2..........','.SWWS2..........',
      '..3yyy3.........','.SWWS2..........','.SWWS2..........','.SWWS2..........',
      '................','...111..........','...1M1..........','...1M1..........',
    ],
    side: [
      '................','................','...........2SS2.','..........2SWWS.',
      '.........2SWWS..','.........2SWWS..','........2SWWS...','........2SWWS...',
      '.......2SWWS....','.......3yyy3....','.......1M1......','.......111......',
      '................','................','................','................',
    ],
    up: [
  ...
  bow: {
    down: [
      '1MN1............','111.............','................','................',
      'w1MN1...........','w1MN1...........','w1MN1...........','.1MN1...........',
      '.1MN1...........','w1MN1...........','w1MN1...........','w1MN1...........',
      '................','................','111.............','1MN1............',
    ],
    side: [
      '................','................','............111.','...........1NM1.',
      '..........1NM1..','..........1NM1w.','..........1NM1w.','..........1NM1w.',
      '..........1NM1w.','..........1NM1w.','..........1NM1..','...........1NM1.',
      '............111.','................','................','................',
    ],
    up: [
      '................','................','.............111','............1NM1',
      '...........1NM1.','...........1NM1w','...........1NM1w','...........1NM1w',
      '...........1NM1w','...........1NM1w','...........1NM1w','...........1NM1.',
      '............1NM1','.............111','................','................',
    ],
  },
  wand: {
...
export function bakeAll() {
  ...
  /* 손에 든 것: 방향마다 하나씩, 왼쪽은 옆모습을 뒤집어 만든다. */
  for (const [type, views] of Object.entries(HELD)) {
    for (const view of VIEWS) {
      const g = viewOf(views, view);
      if (view === 'side') {
        baked.set(`held:${type}:right`, bakeGrid(g));
        baked.set(`held:${type}:left`,  bakeGrid(g, null, true));
      } else {
        baked.set(`held:${type}:${view}`, bakeGrid(g));
      }
    }
  }

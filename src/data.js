...
export const ARTS = {
  warrior: [
    ...
    { id:'brace',    name:'버텨선다', short:'버팀', lv:9,  stam:4,
  ...
  paladin: [
    ...
    { id:'bulwark', name:'불굴',        short:'불굴', lv:9,  oath:5,
...
export const RELIC_CRACKS = {
  ...
  ember:   { c:'③', at:['floor', 5],   n:'항아리가 비지 않는다',
  ...
  brand:   { c:'①', at:['elite', 14],  n:'인두가 안 식는다',
  ...
  paradox: { c:'②', at:['fused', 0],   n:'값을 적은 줄이 안 맞는다',

...
export const STRANGE = [
  ...
  { id:'angel', n:'고대의 천사', spr:'r_eye',
    ...
    pull:'물약을 많이 마신 판' },
  /* ── 그리고 하나 더 ──────────────────────────────────────
     층대 4~6이 하는 말은 「나보다 앞서 온 사람이 있었다」이고, 이 층은
     그것을 끝까지 민다. 아홉이 이미 값·벽·은신·시계·눈·물러나기·
     소리·회복·성장을 하나씩 건드리는데, **장비**만 아무도 안 건드렸다.
     여기가 그 축이다. */
  { id:'gear', n:'두고 간 것들', spr:'armor',
    lore:'벽까지 장비가 쌓여 있다. 어느 것도 온전하지 않고, 어느 것도 여기서 만든 것이 아니다.',
    t:'바닥에 떨어지는 것이 세 배다. 대신 여기 있는 것들이 **그것을 걸치고 있다** — 전부 정예다.',
    mods:{ rooms:[5,7], size:[6,10], light:0.85, water:0, web:0.5, mob:0.85 },
    pull:'장비를 많이 바꾼 판' },
...
/* 4·8·12층. 신이 말을 거는 리듬이다. 판에 셋 — 그보다 잦으면 각각이
   「그 판의 성격」이 아니라 버프 목록이 되고, 드물면 두 번째 판까지
   기억에 안 남는다.

   이 상수의 이름은 ARCANA_AT 였다. 아르카나를 지우면서 이름도 옮긴다 —
   아르카나가 쓰던 리듬을 신이 물려받은 것이지, 아르카나가 남아 있는
   것이 아니다. */
export const PLEDGE_AT = [4, 8, 12];

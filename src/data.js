...
/* ── bestiary ─────────────────────────────────────────────
   ...
   ai:   'hunt' | 'erratic' | 'still'                        */
export const MONSTERS = [
  { spr:'rat',     n:'커다란 쥐',        d:1,  rar:10, hp:5,   atk:3,  ac:1,  xp:2,   ai:'hunt' },
  { spr:'bat',     n:'과일 박쥐',        d:1,  rar:9,  hp:6,   atk:3,  ac:3,  xp:3,   ai:'erratic' },
  { spr:'mold',    n:'회색 곰팡이',      d:1,  rar:5,  hp:14,  atk:5,  ac:1,  xp:5,   ai:'still' },
  { spr:'snake',   n:'흰 큰뱀',          d:2,  rar:8,  hp:10,  atk:4,  ac:3,  xp:5,   ai:'hunt' },
  { spr:'kobold',  n:'코볼드',           d:2,  rar:10, hp:12,  atk:6,  ac:4,  xp:8,   ai:'hunt' },
  { spr:'dog',     n:'들개',             d:3,  rar:9,  hp:11,  atk:6,  ac:3,  xp:9,   ai:'hunt' },
  { spr:'jelly',   n:'푸른 젤리',        d:4,  rar:5,  hp:34,  atk:8,  ac:1,  xp:20,  ai:'still' },
  { spr:'spider',  n:'동굴 거미',        d:4,  rar:8,  hp:16,  atk:8,  ac:5,  xp:16,  ai:'hunt' },
  { spr:'orc',     n:'오크 병사',        d:5,  rar:11, hp:24,  atk:10, ac:7,  xp:24,  ai:'hunt' },
  { spr:'orc',     n:'검은 오크',        d:8,  rar:9,  hp:36,  atk:13, ac:9,  xp:42,  ai:'hunt' },
  { spr:'dog',     n:'늑대',             d:8,  rar:8,  hp:30,  atk:12, ac:6,  xp:38,  ai:'hunt' },
  { spr:'ogre',    n:'오우거',           d:10, rar:8,  hp:52,  atk:16, ac:10, xp:70,  ai:'hunt' },
  { spr:'mummy',   n:'미라',             d:11, rar:6,  hp:48,  atk:15, ac:12, xp:75,  ai:'hunt' },
  { spr:'troll',   n:'동굴 트롤',        d:12, rar:9,  hp:70,  atk:19, ac:13, xp:110, ai:'hunt' },
  { spr:'wraith',  n:'망령',             d:14, rar:7,  hp:60,  atk:20, ac:15, xp:130, ai:'erratic' },
  { spr:'giant',   n:'언덕 거인',        d:15, rar:7,  hp:95,  atk:23, ac:14, xp:170, ai:'hunt' },
  { spr:'vampire', n:'흡혈귀',           d:17, rar:6,  hp:88,  atk:26, ac:17, xp:220, ai:'hunt' },
  { spr:'dragon',  n:'어린 붉은 용',     d:18, rar:5,  hp:120, atk:28, ac:20, xp:300, ai:'hunt' },
  { spr:'wyrm',    n:'서리 비룡',        d:20, rar:5,  hp:140, atk:31, ac:22, xp:380, ai:'hunt' },
  { spr:'lich',    n:'리치',             d:22, rar:4,  hp:130, atk:35, ac:24, xp:480, ai:'hunt' },
];

export const BOSS = {
  spr:'balemperor', n:'잿불의 대군주', hp:700, atk:46, ac:30, xp:6000, ai:'hunt', boss:true,
};

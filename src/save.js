...
export function snapshot() {
  ...
  return {
    ...
    heat: G.heat || 0, provoked: G.provoked || 0, swapped: G.swapped || 0,
...
export function slotDigest(slot) {
  ...
  return {
    ...
    branch: d.branch, strangeSeen: d.run?.strangeSeen || [],

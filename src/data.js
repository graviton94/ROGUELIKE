...
export const SPELLS_CLASS = {
  ...
  mage: [
    ...
    /* 13레벨이었다. 그러면 궁극기(12)를 배운 **뒤에** 편의 주문
       하나가 더 열리고, 사다리의 마지막 칸이 「이 층의 지도를 기억해
       낸다」가 된다 — 여덟 칸이 무엇을 향해 오르는지가 마지막 줄에서
       흐려진다. 궁극기가 끝이어야 사다리다.
       10으로 내린다: 서리(9) 바로 다음이고, 그 레벨의 통이 29라
       8마나짜리를 실제로 낼 수 있다. 값도 자리도 안 바꾸고 순서만
       바로 세운 것이다. */
    { id:'map',    name:'지형 파악',   short:'지도', lv:10, cost:8,  desc:'이 층의 지도를 기억해 낸다.' },
    /* ── 마법사의 궁극기 ──────────────────────────────────

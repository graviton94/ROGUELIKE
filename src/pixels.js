...
export const SPRITES = {
  ...
  /* The eye is a white pixel with black around it. A black eye on a dark floor is no eye at all — the same mistake as drawing the spider's legs in the outline colour. */
  /* A face, not a side view. At sixteen pixels a creature drawn in profile is a loaf; every one of these gets a head turned to the player, and everything below it is small. */
  /* Round ears, a pink nose and two front teeth. The three small beasts used to be the same tan head — a rat is its ears and its teeth. */
  rat: [
    '................',
    '..kkk......kkk..',
    '.kNNNk....kNNNk.',
...
export const RACE_BODY = {
  /* ── 방향 ─────────────────────────────────────────────────
     ...
     Scaled off the Game Boy Colour overworld: the figure is about
     eleven pixels tall inside a sixteen-pixel box, and it is made
     of four colours — hair, skin, body, and the black that goes
     around all of it. The margin matters as much as the drawing.
     Filling the box and using seven colours is what made every
     earlier pass look cramped. */
  'human@down': [
    '................',
    '................',
    '.....kkkkkk.....',
